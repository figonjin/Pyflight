...
def main():
    ...
    passenger_config.adjust_passenger_amount(1, 2)
    passenger_config.adjust_passenger_amount(2, 1)
    passenger_config.select_flight_class(2)
    ...
    flight_config.input_departure_arrival_date('11-27', False)
